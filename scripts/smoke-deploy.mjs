...
const endpoints = [
  { path: '', includes: ['ProfilePage', '/work/exploitrank/', 'data-analytics-event="work_detail_open"', 'data-analytics-consent', 'http-equiv="Content-Security-Policy"', 'name="referrer" content="no-referrer"'] },
